                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="First Name" name="first_name" id="fname" value="{{ $editCellCoordinator->fname }}" required>
                                <span class="text-danger error" id="cell_first_name"></span>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="{{ $editCellCoordinator->lname }}" required>
                                <span class="text-danger error" id="cell_last_name"></span>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
