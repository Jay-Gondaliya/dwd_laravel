                    ...
                    <div class="row row-sm">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Full Name" name="name" value="{{ $editStateCoordinator->name }}" required>
                                <span class="text-danger error" id="state_name"></span>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="validationCustom01" class="form-label">Username</label>
                                <input type="text" class="form-control" placeholder="Username" name="username" value="{{ $editStateCoordinator->username }}" required>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="age" value="{{ $editStateCoordinator->age }}" placeholder="Age">
                        ...
                        <div class="wd-200 mg-b-30">
                                <div class="input-group">
                                    ...
                                    </div><input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="date" name="dob" value="{{ $editStateCoordinator->dob }}"/>
                                </div>
