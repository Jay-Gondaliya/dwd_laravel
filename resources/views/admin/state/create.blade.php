    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <form class="mt-5" id="addStateCoordinatorForm">
                @csrf
                <input type="hidden" name="id" value="{{ $editStateCoordinator->id }}"/>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="{{ $editStateCoordinator->username }}" required>
