...
@section('content')
    ...
    <div class="page-header border-bottom">
        <div class="page-leftheader">
            <h4 class="page-title mb-0 text-primary">Field Volunteers in my team</h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Volunteers List</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap" id="example1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="action_icon"><a href="#"><i class="fa fa-eye"></i></a></td>
                                </tr>
                                <tr>
