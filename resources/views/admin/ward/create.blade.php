    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <form class="mt-5" id="addWardCoordinatorForm">
                @csrf
                <input type="hidden" name="id" id="id" value="{{ $editWardCoordinator->id }}"/>
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="First Name" name="first_name" id="fname" value="{{ $editWardCoordinator->fname }}" required>
                                <span class="text-danger error" id="ward_first_name"></span>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="{{ $editWardCoordinator->lname }}" required>
                                <span class="text-danger error" id="ward_last_name"></span>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="wd-200 mg-b-30">
                                <div class="input-group">
                                    ...
                                    </div><input class="form-control fc-datepicker" id="dob" max="{{ date('Y-m-d') }}" placeholder="MM/DD/YYYY" type="date" name="dob" value="{{ $editWardCoordinator->dob }}"/>
                                </div>
